...
async function main() {
  ...
  deployments["USDG"] = usdg.address;
  // const usdg = await contractAt("USDG", "0x45096e7aA921f27590f8F19e457794EB09678141")
  
  const router = await deployContract("Router", [vault.address, usdg.address, deployments.WETH])
  ...
  const glpManager = await deployContract("GlpManager", [vault.address, usdg.address, glp.address, deployments.ZERO, 15 * 60])
  ...
  deployments["vaultErrorController"] = vaultErrorController.address;
